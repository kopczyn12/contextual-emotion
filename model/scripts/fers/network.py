...
FERS model architecture from paper: https://arxiv.org/pdf/2007.04514.pdf
...
class Decoder(nn.Module):
    """ Decoder part of the FERS network """
    def __init__(self, vgg_name='VGG13', out_channel=3, mem=512, num_class=NUM_OF_CLASSES):
    ...
    def forward(self, feature, prob_t, shortcut_list, transform=False):
        ...
        :param feature: Features tensor
        :param prob_t: Probability distribution of the synthesized face
        :param shortcut_list: Layer to take input from
        :param transform: Whether to transform or not
        :return:
        """
    ...
    def make_layers(self, cfg):
        """
        Helper function for creating the network structure
        :param cfg: Config dict, VGG13
        :return: Layers of the decoder
        """
        layers = []
        for x in cfg:
            if 'D1' in x:
...
class Classifier(nn.Module):
    """ Classifier part of the network, used to obtain predictions of the human emotion"""
    def __init__(self, nz=NUM_OF_CLASSES, nc=512, _size=1):
        """
...
class Discriminator(nn.Module):
    """"""
    def __init__(self, input_shape=(1, 96, 96), num_class=NUM_OF_CLASSES):
        """
...
class FERSNet(nn.Module):
    """"""
    def __init__(self, vgg_name='VGG13', num_class=NUM_OF_CLASSES, mem_size=512, k_channel=1, inter=64):
        """
