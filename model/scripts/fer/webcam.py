...
model = tf.keras.models.load_model('trained_models/fer_model.h5')
...
def classify_emotion(face):
    """
    Function that classifies emotion, changes the size of face detection, make prediction and check accuracy
    :param face: The size of face detected by haar cascade
    :return: prediction of emotion and accuracy
    """
...
def main():
    """
    Main fuction that creates and webcam for model, it detects faces and its emotion.
    :return:
    """
    # webcam
