...
def main(args):
    """
    Entrypoint for the training of FERS network. Logging functionalities have been disabled as
    conflicting versions of the frameworks significantly hindered progress.
    :param args: Arguments passed to the training script from the command line
    :return: None, this is the mainfunction
    """
    ...
    for i in range(beginner, epoch):
        ...
        print('Train Epoch = {} | Valid Accuracy = {} | Best Accuracy = {}'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_root", type=str, default='/home/krzysztof/Repos/contextual-emotion/model'
                                                          '/scripts/dataset_ckplus/ckplus')
