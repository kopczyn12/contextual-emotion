...
def evaluate_model(model, dataloader, device):
        """
    Evaluates the ConvNext model.

    This function evaluates the ConvNext model using a test dataset. 
    The predictions and actual labels are returned for further analysis.

    :param model: The ConvNext model used for classification.
    :type model: ConvNextForImageClassification
    :param dataloader: The DataLoader for the testing dataset.
...
def load_data(train_dir, test_dir):
        """
    Loads and transforms the training and testing datasets.

    This function uses torchvision to load and transform the datasets for training and testing.

    :param train_dir: The directory that contains the training images.
    :type train_dir: str
    :param test_dir: The directory that contains the testing images.
    :type test_dir: str
...
train_loader, test_loader = load_data('/home/krzysztof/Repos/contextual-emotion/model/scripts/Dataset_emotions/train',
                                      '/home/krzysztof/Repos/contextual-emotion/model/scripts/Dataset_emotions/test')
...
plt.ylabel('Actual')
plt.savefig('confusin_matrix_convnext.png')
